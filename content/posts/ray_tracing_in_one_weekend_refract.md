...
本文是对Ray Tracing in One Weekend中[折射](https://raytracing.github.io/books/RayTracingInOneWeekend.html#dielectrics/snell^{\prime}slaw)一节公式的推导
...
因为$R_{\parallel}^{\prime}$和$R_{\bot}^{\prime}$是垂直的，并且是同一个单位向量的分量，可以得出$R_{\parallel}^{\prime}$的长度为$ \sqrt{1 - |\mathbf{R^{\prime}}\_{\bot}|^2}$，而$R\_{\parallel}^{\prime}$的方向和$n$相反，所以
